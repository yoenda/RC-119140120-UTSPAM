  ...
  return (
    <View>
        <Pressable style={styles.container} onPress = {props.onPress}>
            ...
            <Text style={styles.fromText}>{props.selectorType == 'Tujuan' ? props.destinationPoint.name ? props.destinationPoint.name : 'Tujuan' : props.originPoint.name ? props.originPoint.name : props.selectorType}</Text>
        </Pressable>
    </View>
  )
}
